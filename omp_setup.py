...
if platform.system() == 'Darwin':
    extra_compile_args += ['-std=c++11', '-mmacosx-version-min=10.9', '-Xpreprocessor', '-fopenmp']
    extra_link_args += ['-stdlib=libc++', '-mmacosx-version-min=10.9', '-lomp']
...
setup(name='fastannoy',
      ...
      author='Fu Chi Ao',
      author_email='fuchia@andrew.cmu.edu',
